...
def vgg11(pretrained=False, **kwargs):
    """VGG 11-layer model_ori (configuration "A")
    Args:
...
def vgg11_bn(pretrained=False, **kwargs):
    """VGG 11-layer model_ori (configuration "A") with batch normalization
    Args:
        pretrained (bool): If True, returns a model_ori pre-trained on ImageNet
    """
    if pretrained:
...
def vgg13(pretrained=False, **kwargs):
    """VGG 13-layer model_ori (configuration "B")
    Args:
        pretrained (bool): If True, returns a model_ori pre-trained on ImageNet
    """
    if pretrained:
...
def vgg13_bn(pretrained=False, **kwargs):
    """VGG 13-layer model_ori (configuration "B") with batch normalization
    Args:
        pretrained (bool): If True, returns a model_ori pre-trained on ImageNet
    """
    if pretrained:
...
def vgg16(pretrained=False, **kwargs):
    """VGG 16-layer model_ori (configuration "D")
    Args:
        pretrained (bool): If True, returns a model_ori pre-trained on ImageNet
    """
    if pretrained:
    ...
    if pretrained:
        #model_ori.load_state_dict(model_zoo.load_url(model_urls['vgg16_bn']))
...
def vgg16_bn(pretrained=False, **kwargs):
    """VGG 16-layer model_ori (configuration "D") with batch normalization
    Args:
        pretrained (bool): If True, returns a model_ori pre-trained on ImageNet
    """
    if pretrained:
    ...
    if pretrained:
        #model_ori.load_state_dict(model_zoo.load_url(model_urls['vgg16_bn']))
        model_path = './pretrained_model/vgg16_bn.pth'
        model.load_state_dict(torch.load(model_path), strict=False)        
    return model


def vgg19(pretrained=False, **kwargs):
    """VGG 19-layer model_ori (configuration "E")
    Args:
        pretrained (bool): If True, returns a model_ori pre-trained on ImageNet
    """
    if pretrained:
...
def vgg19_bn(pretrained=False, **kwargs):
    """VGG 19-layer model_ori (configuration 'E') with batch normalization
    Args:
        pretrained (bool): If True, returns a model_ori pre-trained on ImageNet
    """
    if pretrained:
