...
import cv2
import sys
sys.path.append('/workspace/MGANet')
...
def poly_learning_rate(optimizer, base_lr, curr_iter, max_iter, power=0.9, index_split=-1, scale_lr=10., warmup=False, warmup_step=500):
    ...
    if warmup and curr_iter < warmup_step:
        ...
        lr = base_lr * (1 - float(curr_iter) / max_iter) ** power # < 1.0
...
def get_save_path(args):
    ...
    args.snapshot_path = 'exp/MGANet_iSAID/{}/{}/split{}/{}/snapshot'.format(args.data_set, args.arch, args.split, backbone_str)
    args.result_path = 'exp/MGANet_iSAID/{}/{}/split{}/{}/result'.format(args.data_set, args.arch, args.split, backbone_str)
